        ...
        <AnimatedPage>
            <div className="detail-page">
                <div className="detail-container">
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '4rem 0 2rem 0', padding: '2rem', background: 'var(--bg)', borderRadius: '16px', border: '1px solid var(--border)' }}>
